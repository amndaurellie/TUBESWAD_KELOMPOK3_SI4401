...
@section('content')
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-12">
                <h2 class="text-center">Tambah Aktivitas</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('aktivitas.store') }}" method="post" class="needs-validation" novalidate=""
                    ...
                    <div class="form-wrap">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kontak_person') is-invalid @enderror" id="kontak_person" name="kontak_person">
                            @error('kontak_person')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
