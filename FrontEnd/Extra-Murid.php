        ...
        <div class="row row-cols-1 row-cols-md-3 g-4" id="card">
            <div class="col">
                <div class="card h-100">
                    <img src="soccer.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Soccer</h5>
                        <p class="card-text">1st Place Soccer Champion for High School...</p>
                        <a href="ExtraDetail-Murid.php" class="btn btn-primary rounded-pill">Lanjut Baca</a>
                    </div>
                </div>
            </div>
            <div class="col">
