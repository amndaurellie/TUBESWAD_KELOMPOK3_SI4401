...
<body>
    ...
    <ul class="nav nav-tabs" style="width:180px;margin-left:170px">
        <li class="nav-item">
            <a class="nav-link" href="Home-Murid.php">Form</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="Absent-Murid.php">Assigment</a>
        </li>
    </ul>
    </nav>

    <form action="Home-Murid.php" method="POST" style="margin-left: 180px; margin-right: 180px">
    <br>
        <div class="form-wrap">
