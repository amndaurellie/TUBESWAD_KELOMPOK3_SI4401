...
<body>
    ...
    <br><br><br><br>
    <center>
        <font face="San-serif" size="6"><b>Profile</b></font>
    </center>
    <br>
    <form href="Profile.php" method=POST>
        <div class="form-wrap" style="margin-left: 160px; margin-right: 160px; padding-left:150px; padding-right:150px">
            <div class="mb-3">
                <label for="username" class="form-label">Full Name</label>
                <input type="text" class="form-control" id="username" name="username" value="Amanda Aurellie Utami">
            </div>
            <div class="mb-3">
                <label for="username" class="form-label">Phone Number</label>
                <input type="text" class="form-control" id="username" name="username" value="08968805552">
            </div>
            <div class="mb-3">
                <label for="username" class="form-label">Email</label>
                <input type="text" class="form-control" id="username" name="username" value="amndaurellie@gmail.com">
            </div>
            <div class="mb-3">
                <label for="username" class="form-label">Password</label>
                <input type="text" class="form-control" id="username" name="username" value=1234>
            </div>
            <br>
            <div class="d-grid gap-2" style="width:15%;margin-left:auto;margin-right:0"> 
                <button type="submit" class="btn btn-primary" id="ubah" name="ubah" value="ubah">Change</button>
            </div>
        </div>
    </form>
