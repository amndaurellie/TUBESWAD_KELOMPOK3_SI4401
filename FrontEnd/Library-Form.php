...
<body>
    <nav class="navbar navbar-expand-sm navbar-light fixed-top" style="background-color: #ffffff;">
        <div class="container-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link" href="Home-Murid.php" style="margin-left: 80px;font-family:San-serif"><b>ABSENT</b></a>
    ...
    <br>
    <form action="Library-Confirm.php" method="POST" style="margin-left: 160px; margin-right: 160px; padding-left:150px; padding-right:150px">
        <div class="mb-3">
            <input type="hidden" id="id_customer" name="id_customer">
        </div>
        <div class="form-wrap">
            <div class="mb-3">
                <label for="username" class="form-label">Full Name <font style="color:#c0136a">*</font></label>
                <input type="text" class="form-control" id="username" name="username">
            </div>
            <div class="input-group">
                <div class="input-wrap" style="width: 355px; margin-right:20px">
                    <label for="nis" class="form-label">NIS</label>
                    <input type="text" class="form-control" id="nis" name="nis">
                </div>
                <div class="input-wrap" style="width: 355px">
            ...
            <div class="input-group">
                <div class="input-wrap" style="width: 355px; margin-right:20px">
                    <label for="nis" class="form-label">Start Date</label>
                    <input type="date" class="form-control" id="nis" name="nis">
                </div>
                <div class="input-wrap" style="width: 355px">
                    <label for="class" class="form-label">Return Date</label>
                    <input type="date" class="form-control" id="class" name="class">
                </div>
            </div>
