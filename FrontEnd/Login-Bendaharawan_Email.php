...
<body>
    <div class="row">
        <div class="col-6" style="color:white; background-color:#85A9FF">
            <br>
            <form action="Home-Bendaharawan.php" method="POST" style="padding-left: 50px; padding-right: 50px; margin-right:70px">
                <div class="form_wrap" style="margin-top:100px;margin-left:70px">
                    ...
                    <br>
                    <p style="font-family:San-serif">Login with <a href="Login-Bendaharawan_Hp.php" target = "_self" style="color:blue;text-decoration:none">Phone Number</a></p>
                    <p style="font-family:San-serif">Don't have an account? <a href="Signup-Bendaharawan.php" target = "_self" style="color:blue;text-decoration:none">Sign Up</a></p>
                </div><br><br><br><br>
            </form>
        </div>

        <div class="col">
            <p style="font-family:San-serif;font-size:50px;margin-top:80px;margin-left:130px"><b>Welcome, Treasurer.</b></p>
            <img src="vector\bendaharawan.jpg" style="width:55%;margin-top:30px;margin-left:160px">
        </div>
    </div>
</body>
</html>