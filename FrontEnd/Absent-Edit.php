...
<body>
    ...
    <form action="Home-Guru.php" method="POST" style="margin-left: 180px; margin-right: 180px">
    <br>
        <div class="form-wrap">
        <input type="hidden" id="id" name="id">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama" value="Amanda Aurellie Utami">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nis" name="nis" value="5012067">
            </div>
            <div class="mb-3">
                <label for="date" class="form-label">Date</label>
                <input type="date" class="form-control" id="date" name="date" value="12/24/2022">
            </div>
            <div class="mb-5">
                <div>            
                ...
                <div class="form-check">
                    <input class="form-check-input checked" type="checkbox" name="description" id="attend" value="Attend">
                ...
                <div class="mb-3">
                    <label for="tugas" class="form-label">File Submission</label>
                    <input type="file" class="form-control" id="tugas" name="tugas">
                </div>
            </div><br>
            <div class="mb-1" style="width:15%;margin-left:auto;margin-right:0">
                <button type="submit" class="btn btn-primary" id="apply" name="apply" value="apply">Edit</button>
            </div>
        </div>
    </form>
