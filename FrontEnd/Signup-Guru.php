...
<body>
    <div class="row">
        <div class="col-6" style="color:white; background-color:#85A9FF">
            <form action="Login-Guru_Email.php" method="POST" style="padding-left: 50px; padding-right: 50px; margin-right:70px">
                <div class="form_wrap" style="margin-top:60px;margin-left:70px">
                    ...
                    <br>
                    <p style="font-family:San-serif">Already have an account? <a href="Login-Guru_Email.php" target = "_self" style="color:blue;text-decoration:none">Login</a> </p>
                </div><br><br>
            </form>
        </div>
