...
<body>
    ...
    <center>
        <font face="San-serif" size="6"><b>Payment List</b></font>
    </center>
    <br>
            ...
            <table class="table table-striped" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Rp 600.000</td>
                        <td>23/11/2022</td>
                        <td style="color:#104DAA">Paid</td>
                        <td>
                            <a href="PaymentAdmin-Edit.php">
                                <button type="submit" class="btn btn-primary" id="confirm" name="confirm" style="margin-left:5px">Confirm</button>
                            </a>
                        </td>
                    </tr>
                    <tr>
