...
<body>
        ...
        <div class="container-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link" href="Home-Guru.php" style="margin-left: 150px;font-family:San-serif"><b>ABSENT</b></a>
                    <a class="nav-link" href="Extra-Guru.php" style="margin-left: 20px;font-family:San-serif">EXTRACURRICULAR</a>
    ...
    <br><br><br><br>
    <center>
        <font face="San-serif" size="6"><b>Absent Data</b></font>
    </center>
    <br><br>
    
    <table class="table table-striped" style="margin-left:160px;width:75%">
        <thead>
            <tr>
        ...
        <tbody>
            <tr>
                ...
                <td>Attend</td>
                <td>
                    <a href="Absent-Edit.php">
                        <button type="submit" class="btn btn-primary" id="request" name="request" style="size:20%;margin-left:5px">Edit</button>
                    </a>
                    <a href="">
                        <button type="submit" class="btn btn-danger" id="request" name="request">Delete</button>
                    </a>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <a href="Absent-Edit.php">
                        <button type="submit" class="btn btn-primary" id="request" name="request" style="margin-left:5px">Edit</button>
                    </a>
                    <a href="">
                        <button type="submit" class="btn btn-danger" id="request" name="request">Delete</button>
                    </a>
    ...
    <div class="mb-1" style="width:30%;margin-left:auto;margin-right:0">
        <a href="Absent-Guru.php">
            <button type="submit" class="btn btn-primary" id="request" name="request" style="margin-left:40px;width:20%">Add</button>
        </a>
        <a href="">
            <button type="submit" class="btn btn-primary" id="request" name="request" style="margin-left:10px;width:20%">Save</button>
        </a>
    </div>
