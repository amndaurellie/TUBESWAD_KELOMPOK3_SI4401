...
<body>
        ...
        <div class="container-md">
            ...
            <ul class="navbar-nav">
                ...
                <a button class="btn btn-outline-dark rounded-3" type="button" style="width:160px;height:40px" data-bs-toggle="dropdown">
                        <p style="font-family:San-serif;margin-left:3px"><b>Bendaharawan<img src="https://cdn1.iconfinder.com/data/icons/ios-11-ui-elements-vol-1/29/25_dropdown_menu_down_arrow-512.png" alt="Logo" width="25" height="25"></b></p>
                    </a>
    ...
    <div class="card">
            ...
            <br>
            <form action="Home-Bendaharawan.php" method="POST" style="margin-left: 10px; margin-right: 10px; padding-left:100px; padding-right:100px">
                <div class="mb-3">
