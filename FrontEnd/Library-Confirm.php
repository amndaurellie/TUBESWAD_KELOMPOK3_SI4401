...
<nav class="navbar navbar-expand-sm navbar-light fixed-top" style="background-color: #ffffff;">
        <div class="container-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link" href="Library-Murid.php" style="margin-left: 20px;font-family:San-serif"><b>LIBRAR</b>Y</a>
    ...
    <br><br><br><br>
    <center>
        <font face="San-serif" size="6"><b>Book Request History</b></font>
    </center>
    <br><br>

    <section style="margin-left:200px;margin-right:200px">
        <div class="card">
            <div class="card-header" style="background-color:#85A9FF;color:white">Book Request</div>
            <table class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>19/06/2022</td>
                        <td>19/06/2022</td>
                        <td style="color:#104DAA">Fined</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Bahasa Korea</td>
