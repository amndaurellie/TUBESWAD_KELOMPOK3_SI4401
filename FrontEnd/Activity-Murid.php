    ...
    <nav class="navbar navbar-expand-sm navbar-light fixed-top" style="background-color: #ffffff;">
        <div class="container-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link" href="Activity-Murid.php" style="margin-left: 20px;font-family:San-serif"><b>ACTIVITY</b></a>
                </div>
            </div>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4" id="card">
            <div class="col">
                <div class="card h-100">
                    <img src="dhuha.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Sholat Dhuha</h5>
                        <p class="card-text">Kegiatan ibadah rutin sholat dhuhah setiap...</p>
                        <a href="ActivityDetail-Murid.php" class="btn btn-primary rounded-pill">Lanjut Baca</a>
                    </div>
                </div>
            </div>
            <div class="col">
