...
<nav class="navbar navbar-expand-sm navbar-light fixed-top" style="background-color: #ffffff;">
        <div class="container-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link" href="Home-Murid.php" style="margin-left: 80px;font-family:San-serif">ABSENT</b></a>
                ...
                <a class="nav-link" href="Extra-Murid.php" style="margin-left: 20px;font-family:San-serif"><b>EXTRACURRICULAR</b></a>
    ...
    <br><br><br><br>
    <center>
        <font face="San-serif" size="6"><b>Extracurricular Details</b></font>
    </center>
    <br><br>
    
    <section style="margin-left: 150px;margin-right: 100px">
        <div class="row row-cols-3">
            <div class="col-2" style="margin-right:400px; margin-top:80px">        
                <img src="Soccer.png"
                style="margin-left:10px;margin-right:10px;margin-top:10px;margin-bottom:10px;" width="200%">
            </div>
            <div class="col-5">
                ...
                <form><br>
                    <div class="form-wrap">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="Soccer" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="type" class="form-label">Type</label>
                            <input type="text" class="form-control" id="type" name="type" value="Sport" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="coach" class="form-label">Coach Name</label>
                            <input type="text" class="form-control" id="coach" name="coach" value="Andi Sucipto" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="achievement" class="form-label">Achievement</label>
                            <textarea type="text" class="form-control" id="achievement" name="achievement" rows="4" disabled>1st Place Soccer Champion for High School
2nd Place Soccer Champion for High School
3rd Place Soccer Champion for High School
                            </textarea><br>
                        </div>
                    </div>
                </form>
