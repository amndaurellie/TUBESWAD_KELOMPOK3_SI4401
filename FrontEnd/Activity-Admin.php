    ...
    <nav class="navbar navbar-expand-sm navbar-light fixed-top" style="background-color: #ffffff;">
        <div class="container-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link" href="Activity-Admin.php" style="margin-left: 20px;font-family:San-serif"><b>ACTIVITY</b></a>
                </div>
            </div>
        ...
        <form action="Activity-Admin.php" method="POST" style="margin-left: 180px; margin-right: 180px"><br>
            <div class="form-wrap">
