...
<body>
    <div class="row">
        <div class="col-6" style="color:white; background-color:#85A9FF">
            <br><br><br>
            <form action="Home-Admin.php" method="POST" style="padding-left: 50px; padding-right: 50px; margin-right:70px">
                <div class="form_wrap" style="margin-top:100px;margin-left:70px">
                    <div class="input_grp">
                        <h4 style="font-family:San-serif">Login</h4><br>
                        <input type="hidden" id="id" name="id">
                        
                        <label for="no_hp" class="form-label" style="font-family:San-serif;font-size:15px">Admin Code</label>
        ...
        <div class="col">
            <p style="font-family:San-serif;font-size:50px;margin-top:80px;margin-left:150px"><b>Welcome, Admin.</b></p>
