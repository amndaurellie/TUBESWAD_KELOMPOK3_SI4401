...
<html>
  <head>
    ...
    <body>
            ...
            <div class="container-md">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" href="Activity-Guru.php" style="margin-left: 20px;font-family:San-serif"><b>ACTIVITY</b></a>
                    </div>
                </div>
        ...
        <br><br><br><br>
        <center>
            <font face="San-serif" size="6"><b>Activity</b></font>
        </center>
        <br><br>
        ...
        <form action="" method="POST" style="margin-left: 180px; margin-right: 180px"><br>
            ...
            <div class="mb-3">
                <label for="tugas" class="form-label">Activity Photo</label>
