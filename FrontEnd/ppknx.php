    ...
    <section style="margin-left: 150px;margin-right: 100px">
        ...
        <div class="row row-cols-3">
            ...
            <div class="col-3" style="margin-right:50px">
                ...
                <font face="San-serif" size="3px">22.12.001</font><br>
                <font face="San-serif" size="3px"><b>Book Title</b></font><br>
                <font face="San-serif" size="3px">Pendidikan Pancasila dan Kewarganegaraan</font><br>
                <font face="San-serif" size="3px"><b>Subject</b></font><br>
                <font face="San-serif" size="3px">Pancasila, Hak Asasi Manusia, Norma</font><br>
                <font face="San-serif" size="3px"><b>Type</b></font><br>
                <font face="San-serif" size="3px">Pelajaran Sekolah</font><br><br>
            </div>
            <div class="col-5">
                <div class="card" style="width:100%">
                    <center>
                ...
                <p style="text-align:justify"><font face="San-serif" size="3px">&emsp;&emsp;Buku ini memuat petunjuk umum dan petunjuk khusus dalam
                    melaksanakan proses pembelajaran di sekolah sekaligus panduan implementasi Kurikulum 2013.<br>
                    &emsp;&emsp; Buku ini merupakan panduan minimal bagi guru dalam membelajarkan peserta didik melalui pendekatan
                    scientific dengan model pembelajaran discovery learning, problem based learning, dan project based learning. <br>
                    &emsp;&emsp; Buku ini diharapkan dapat menjadi salah satu panduan atau referensi bagi pendidik dalam merencanakan,
                    mengembangkan, dan melaksanakan proses pembelajaran serta menilai hasil pembelajaran sesuai dengan konsep Kurikulum 2013.</font></p>
            </div>
        </div>
    </section>
